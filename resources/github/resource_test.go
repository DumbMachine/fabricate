...
func TestAcmeScenarioReadWriteRead(t *testing.T) {
	...
	if !strings.Contains(created.Body.String(), `"id":"github.issue-0001"`) {
		t.Fatalf("create = %d %s", created.Code, created.Body.String())
	}

	persisted := request(t, handler, http.MethodGet, "/repos/acme/web/issues/github.issue-0001", "", testToken)
