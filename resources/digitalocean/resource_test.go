...
func TestAcmeScenarioReadWriteRead(t *testing.T) {
	...
	if !strings.Contains(created.Body.String(), `"id":"digitalocean.droplet-0001"`) {
		t.Fatalf("create = %d %s", created.Code, created.Body.String())
	}

	persisted := request(t, handler, http.MethodGet, "/v2/droplets/digitalocean.droplet-0001", "", testToken)
