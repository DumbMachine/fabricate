...
import (
	...
	"github.com/dumbmachine/fabricate/resources/neon/generated"
...
func TestAcmeScenarioReadWriteRead(t *testing.T) {
	...
	if created.Code != http.StatusOK || !strings.Contains(created.Body.String(), `"id":"neon.project-0001"`) {
		t.Fatalf("create = %d %s", created.Code, created.Body.String())
	}

	persisted := request(t, handler, http.MethodGet, "/api/v2/projects/neon.project-0001", "", testToken)
