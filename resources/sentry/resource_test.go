...
func TestAcmeScenarioReadWriteRead(t *testing.T) {
	...
	if !strings.Contains(created.Body.String(), `"id":"sentry.project-0001"`) {
		t.Fatalf("create = %d %s", created.Code, created.Body.String())
	}

	persisted := request(t, handler, http.MethodGet, "/api/0/projects/acme/sentry.project-0001/", "", testToken)
