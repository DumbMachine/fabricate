...
var rootCmd = &cobra.Command{
	...
	Long:         "fab provisions ephemeral Postgres/MySQL/MongoDB/Redis/Prometheus/SSH instances from declarative profiles and returns connection credentials. Docker-backed by default, with an optional Kubernetes target.",
	SilenceUsage: true,
}
