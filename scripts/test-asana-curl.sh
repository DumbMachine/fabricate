...
"$fab_bin" run --environment "$repo_dir/environments/acme-asana.yaml" -- \
  "$repo_dir/resources/asana/conformance/curl.sh" direct
"$fab_bin" run --environment "$repo_dir/environments/acme-asana.yaml" --proxy -- \
  "$repo_dir/resources/asana/conformance/curl.sh" proxy
